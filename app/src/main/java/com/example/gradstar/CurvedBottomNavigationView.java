...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    public Point mFistCurveStartPoint = new Point();
    public Point mFirstCurveEndPoint = new Point();
    public Point mFistCurveControlPoint1 = new Point();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //Get width and height of nav bar

        mNavigationBarWidth = getWidth();
        mNavigationBarHeight = getHeight();

        //Coordinates(x,y) of the start point before curve

        mFistCurveStartPoint.set((mNavigationBarWidth/2)
        ...
        mSecondCurveEndPoint.set((mNavigationBarWidth/2) + (CURVE_CIRCLE_RADIUS*2)+(CURVE_CIRCLE_RADIUS/2)
                ,0);

        //coordinates(x,y) of the first control point on cubic curve
        mFistCurveControlPoint1.set(mFirstCurveEndPoint.x-(CURVE_CIRCLE_RADIUS*2)+CURVE_CIRCLE_RADIUS,
                mFistCurveStartPoint.y);

        //coordinates(x,y) of the second control point on cubic curve
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        mPath.reset();
        mPath.moveTo(0,0);
        mPath.lineTo(mFistCurveStartPoint.x,mFirstCurveEndPoint.y);

        mPath.cubicTo(mFistCurveControlPoint1.x,mFistCurveControlPoint1.y,
